...
public class MarketListAdapterBuy extends RecyclerView.Adapter<MarketListAdapterBuy.ViewHolder> {

    private ArrayList<String> mItemNames = new ArrayList<>();
    private ArrayList<Integer> mItemPrices = new ArrayList<>();
    private Context mContext;

    public MarketListAdapterBuy(ArrayList<String> itemNames, ArrayList<Integer> itemPrices, Context context) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            System.out.println("Adapter buy: Clicking at posit" +
            ...
            dialogue.putExtra("buy_sell", true);
